...
public class DocumentRepositoryPage extends TestBase{

	
	   WebDriver driver;
	
	    @FindBy(xpath="//*[@class='layout-menuitem-text'][contains(text(),'Document Repository')]") 
		WebElement DocumentRepositorybtn;
		
		@FindBy(xpath="//*[@class='title'][contains(text(),'Doc Repository')]") 	
		WebElement DocRepositoryTitle;
		...
		public  DocumentRepositoryPage(WebDriver driver)
		{
	    	 this.driver = driver;
		...
		public void clickonDocumentRepositoryBtn()
		{
			DocumentRepositorybtn.click();
		}
		
		public String verifytheDocumentRepositoryTitle() {
			
			String DocumentRepositoryPageTitle=DocRepositoryTitle.getText();
			
			return DocumentRepositoryPageTitle;
			
		}
	
		
		public  boolean ValidateDocRepositoryDataBaseLiveRadioBtn() throws InterruptedException {
		...
		public  boolean ValidateDocRepositoryDataBaseArchiveRadioBtn() throws InterruptedException {
		...
		public String validateDocRepositoryAddFilterAlertMessage() throws InterruptedException {
